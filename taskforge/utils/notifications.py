...
class EmailChannel(NotificationChannel):
    ...
    def __init__(self, smtp_host: str, smtp_port: int, username: str, password: str, 
                 use_tls: bool = True, from_address: Optional[str] = None):
...
class InAppChannel(NotificationChannel):
    ...
    async def send(self, notification: Notification, recipient: User) -> bool:
        ...
        try:
            ...
            logger.info(f"In-app notification created for user {recipient.id}: {notification.subject}")
            return True
        except Exception as e:
...
class NotificationManager:
    ...
    def set_template(self, notification_type: NotificationType, template: NotificationTemplate):
        """Set a notification template"""
        self.templates[notification_type] = template
    
    def set_user_preferences(self, user_id: str, preferences: Dict[NotificationType, List[str]]):
        """Set user notification preferences"""
        self.user_preferences[user_id] = preferences
    
    def get_user_channels(self, user_id: str, notification_type: NotificationType) -> List[str]:
    ...
    async def send_notification(
        ...
        for channel_name in channels:
            if channel_name in self.channels:
                try:
                    success = await self.channels[channel_name].send(notification, recipient)
    ...
    async def send_bulk_notifications(
        self, 
        notifications: List[tuple[NotificationType, User, Dict[str, Any]]]
